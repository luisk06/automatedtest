@complete @making @images @forms @makingImages @makingImagesDesktop @formsMakingImagesDesktop @formsMaking

Feature: The user creates an image question since desktop in forms
