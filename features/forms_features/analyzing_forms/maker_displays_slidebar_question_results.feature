@analiticQ @analyzing @forms @complete @formsAnalyzing
...
Feature: Applying a filter to sliderbar question in forms summary view
	...
	Scenario Outline: The user filters the results of a slidebar question in forms by num stops with <numAnswers> answers
		Given that there is a webform app with a "forms" with a slidebar question that has <numStops> stops and <numAnswers> answers
