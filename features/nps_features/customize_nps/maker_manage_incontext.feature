@customize @customizeNps @complete

Feature: Customize settings on NPS

	As an user
	I want to cutomize the incontext view of my NPS
	...
	Background:
		Given the user has "standard" plan
			...
			And that the user is editing a "nps"
	...
	Scenario: The user tries to edit customize settings after activating a NPS
		When that the user has creates a "nps" question
			And the user pass to the "nps" share tab
