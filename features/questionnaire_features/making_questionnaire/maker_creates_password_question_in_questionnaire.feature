@todo @deprecated @making @password @questionnaire @questionnaireMaking

Feature: The user creates a password question in questionnaire

	As an user
	I want to create a password question
	In order for users to answer

	Scenario: The user creates a password question in questionnaire
	...
	Scenario: The user creates a password question in questionnaire with custom maximum and minimum values
		Given the user has an app
			And the user has login
			And the user opens the just created app
			And the user opens the "webform" board
	...
	Scenario: The user creates a password question in questionnaire with confirm password selected
		Given the user has an app
			And the user has login
			And the user opens the just created app
			And the user opens the "webform" board
	...
	Scenario: The user creates a password question in questionnaire with a minimum value lower than allowed
		Given the user has an app
			And the user has login
			And the user opens the just created app
			And the user opens the "webform" board
