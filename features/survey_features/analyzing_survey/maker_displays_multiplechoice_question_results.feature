@analiticQ @analyzing @complete @survey @analyzingMultpleChoice @surveyAnalyzing

Feature: Applying filters to a multiple choice question results in survey summary view
	...
	Scenario Outline: The user filters the results of a multiple choice in survey with <numAnswers> answers
		Given that there is a webform app with a "survey" with a "multiple choice" question that has <numAnswers> answers
