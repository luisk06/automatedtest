@complete @making @images @survey @makingImages @makingImagesUrl @surveyMaking

Feature: The user creates an image question since url in survey
	...
	@smokeTest4
	Scenario: The user creates a image question since Url
	...
	@unitMore
	Scenario: The user creates a image question with multiple selection since Url
		When the user writes the title of the question
			And the user adds all images possible to question since "url"
			And the user adds all title possible to images
	...
	Scenario: The user creates a image question with paths since Url
		When the user writes the title of the question
			And the user adds all images possible to question since "url"
			And the user adds all title possible to images
