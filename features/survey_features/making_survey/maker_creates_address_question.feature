@complete @making @address @survey @surveyMaking

Feature: The user creates an address question in survey

	As an user
	I want to create an address question
	In order for users to answer

	Scenario: The user creates an address question type in survey
