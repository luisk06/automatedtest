@complete @making @yes-no @survey @smokeTest4 @surveyMaking

Feature: The user creates a yes no question in survey
	...
	@yes-noMaking
	Scenario Outline: The user creates yes no question type with <planName> plan
