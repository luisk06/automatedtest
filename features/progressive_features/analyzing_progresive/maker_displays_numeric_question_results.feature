@analyticQ @todo @incompleted @progressiveAnalyze

Feature: The user displays numeric question results in progressive

	As an user
	I want see the results of a numeric question
	In order to analyse them by looking at the charts

	Scenario Outline: The user filters the results of a numeric with <numAnswers> answers in progressive
