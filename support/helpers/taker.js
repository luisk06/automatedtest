...
Taker.prototype.takesQrvey = function (_number) {
...
Taker.prototype.activatesQrvey = function () {
...
Taker.prototype.takesQrveyShared = function () {
...
Taker.prototype.takerClicksOnOk = function () {
	scrollToBottom();
	return this.finds('.spec-user-response-ok').click();
};

Taker.prototype.takerFinish = function (_confirm) {
...
Taker.prototype.selectsOtherQuestion = function () {
...
Taker.prototype.takerTouchStarts = function () {
...
Taker.prototype.getTypeQuestionOnTaker = function (idx) {
...
Taker.prototype.answerAllOnTaker = function (rightAnswers) {
	var defer = protractor.promise.defer();
	var idx = 0;
	var _this = this;
